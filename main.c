...
int main(int argc, char** argv) {
	...
	for (int i = 1; i < argc; i++) {
		...
		if (!strcmp(argv[i], "-a") || !strcmp(argv[i], "--algorithm")) {
			...
			printf("\t-b, --benchmark - this parameter setting benchmark program mode. Should be used with --dataset parameter to set count of numbers being generated and sorted.\n");
			...
			printf("\t-f, --file [ filename ] - setting name of file with numbers that will be sorted. Program puts sorted integers in this file. Cannot be used with -b parameter.\n");
			...
			printf("\t-r, --reverse - sets reverse sorting mode.\n");
